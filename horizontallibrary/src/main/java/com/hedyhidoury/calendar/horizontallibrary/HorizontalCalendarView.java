    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int selectedDateColor = typedArray.getColor(R.styleable
                    .HorizontalCalendarView_selectedBgColor, context.getResources().getColor(R.color.selected_color));
            // today date color
            int todayDateColor = typedArray.getColor(R.styleable
                    .HorizontalCalendarView_todaysDateBgColor, context.getResources().getColor(R.color.selected_color));
            // days text color
            int daysTextColor = typedArray.getColor(R.styleable
                    .HorizontalCalendarView_daysTextColor, context.getResources().getColor(R.color.grey_92));
